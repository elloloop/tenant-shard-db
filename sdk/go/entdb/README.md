...
[![Go Reference](https://pkg.go.dev/badge/github.com/elloloop/tenant-shard-db/sdk/go/entdb/v2.svg)](https://pkg.go.dev/github.com/elloloop/tenant-shard-db/sdk/go/entdb/v2)
...
```bash
go install github.com/elloloop/tenant-shard-db/sdk/go/entdb/v2/cmd/entdb@latest
...
- [pkg.go.dev reference](https://pkg.go.dev/github.com/elloloop/tenant-shard-db/sdk/go/entdb/v2)
