...
import pytest
from sdk.entdb_sdk.schema import NodeTypeDef, FieldDef, FieldKind
from sdk.entdb_sdk.validate import (
    validate_payload,
    validate_or_raise,
    suggest_fields,
)
from sdk.entdb_sdk.errors import ValidationError, UnknownFieldError
...
class TestPayloadValidation:
    ...
    def test_valid_payload(self, user_type):
        ...
        is_valid, errors = validate_payload(user_type, {
