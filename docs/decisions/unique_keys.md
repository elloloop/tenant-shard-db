...
- Related decisions:
  - [ADR-003](../adr/003-acl-model.md) — proto-first schema establishes where capability metadata is declared (same family of "proto declares the permission shape" decisions as keys)
